      ...
      <div class="bg-light p-md-5 h-75">
   		<form action="">
   			<div class="form-group">
   				...
   				<input type="text" id="amount" class="form-control" placeholder="이체 금액을 입력하시오" name="amount">
   			</div>
   			<div class="form-group">
   				<label for="wAccountNumber">출금계좌번호:</label>
   				<input type="text" id="wAccountNumber" class="form-control" placeholder="출금 계좌번호를 입력하시오" name="wAccountNumber">
   			</div>
   			<div class="form-group">
   				<label for="dAccountNumber">이체계좌번호:</label>
   				<input type="text" id="dAccountNumber" class="form-control" placeholder="이체 계좌번호를 입력하시오" name="dAccountNumber">
   			</div>
   			<div class="form-group">
